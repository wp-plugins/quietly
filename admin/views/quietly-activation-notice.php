...
<div class="quietly-wp-admin__activation-notice updated">
	...
	<p>
		<a href="<?php echo admin_url( 'plugins.php?page=' . QUIETLY_WP_SLUG ) . '#setup_token'; ?>" class="button button-primary"><?php /* TRANSLATORS: plugin */ _e( 'Connect with Quietly', QUIETLY_WP_SLUG ); ?></a>
	</p>
</div>